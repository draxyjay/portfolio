...
const Home = () => {
	const logoPathRef: RefObject<SVGGElement> = React.createRef(),
		cuttedLogoPathRef: RefObject<SVGGElement> = React.createRef(),
		logoSVGRef: RefObject<SVGSVGElement> = React.createRef(),
		nameRef: RefObject<HTMLDivElement> = React.createRef(),
